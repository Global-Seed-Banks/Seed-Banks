...
rich_biome_global_posterior <-  rich_biome.fixed.p %>% 
  ...
  mutate(rich.aq.global = (`b_Centred_log_Total_Sample_Area_m2` ),
         rich.arable.global = (`b_Centred_log_Total_Sample_Area_m2` + `b_Centred_log_Total_Sample_Area_m2:Biome_HabArable` ),
         rich.bor.global = (`b_Centred_log_Total_Sample_Area_m2` + `b_Centred_log_Total_Sample_Area_m2:Biome_HabBorealForestsDTaiga` ),
         rich.des.global = (`b_Centred_log_Total_Sample_Area_m2` + `b_Centred_log_Total_Sample_Area_m2:Biome_HabDesertsandXericShrublands`),
         rich.fgs.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabFloodedGrasslandsandSavannas`),
         rich.mang.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabMangroves`),
         rich.medfs.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabMediterraneanForestsWoodlandsandScrub`),
         rich.mongs.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabMontaneGrasslandsandShrublands`),
         rich.tempbf.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTemperateBroadleafandMixedForests`),
         rich.tempcf.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTemperateConiferForests`),
         rich.tempgs.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTemperateGrasslandsSavannasandShrublands`),
         rich.tropcf.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTropicalandSubtropicalConiferousForests`),
         rich.tropdbf.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTropicalandSubtropicalDryBroadleafForests`),
         rich.tropgs.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTropicalandSubtropicalGrasslandsSavannasandShrublands`),
         rich.tropmbf.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTropicalandSubtropicalMoistBroadleafForests`),
         rich.tund.global = (`b_Centred_log_Total_Sample_Area_m2`+ `b_Centred_log_Total_Sample_Area_m2:Biome_HabTundra`),
  ) %>%
  dplyr::select(c(rich.aq.global, rich.arable.global, rich.bor.global, rich.des.global, rich.fgs.global, rich.mang.global, rich.medfs.global,
...
# rich.tropdbf.global, rich.tropgs.global, rich.tropmbf.global,
# rich.tund.global
rich.aq.p <-  rich_biome_global_posterior %>% 
...
rich.arable.p <-  rich_biome_global_posterior %>% 
...
global.rich_biome.p <- bind_rows(rich.aq.p, rich.arable.p, rich.bor.p, rich.des.p,
