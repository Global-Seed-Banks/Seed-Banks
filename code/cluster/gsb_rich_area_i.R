...
rich.p_i_2 <- brm(Total_Species ~ log_Total_Sample_Area_mm2 *  Biome_WWF_Zone  * Habitat_Broad + (  Biome_WWF_Zone *  Habitat_Broad | Habitat_Degraded ) + ( 1 | Method/studyID/rowID ),
